...
[Generator]
public class LazyStackFactoryGenerator : ISourceGenerator
{
...
");
    ...
    private SourceText GenerateRegistrationClass(string namespaceName, List<string> classes, HashSet<string> namespaces)
    {
        //Log(context, $"GenerateClassModelSource: {namespaceName} {modelType}");
        var sourceBuilder = new StringBuilder();
        var conformantNamespace = namespaceName.Replace(".", "_");
...
");
    ...
    private static readonly DiagnosticDescriptor _messageRule = new DiagnosticDescriptor(
        id: "LZSG0002",
        title: "LazyStack.Client.FactoryGenerator Source Generator Message",
        messageFormat: "{0}",
