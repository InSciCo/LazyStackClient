# LazyStack.Client.FactoryGenerator
...
```<ProjectReference Include="..\..\LazyStackClient\LazyStack.Client.TreeViewModel\LazyStack.Client.TreeViewModel.csproj" OutputItemType="Analyzer" />```
