...
| Layer | Packages |
| --- | --- |	
| Base | LazyStack.Client.Base |
| Model | ClientSchema library specific to each app. Usually generated by LazyStack MDD. |
| View Model | LazyStack.Client.ViewModels.*, ClientSDK specific to each app. Usually generated by LazyStack MDD. |
| Blazor View | LazyStack.Blazor.* |
| Blazorise View | LazyStack.BlazoriseComponents.* |
| MAUI View | LazyStack.Client.MAUI |

## Authentication (cross cutting concern)
LazyStack.Client.Auth - referenced by ClientSDK 
LazyStack.Client.Auth.Cognito
LazyStack.AwsSettings
LazyStack.Client.CognitoValidation
...
It references the LazyStack.Client.Auth library.
...
| Level | Library |
| --- | --- |
| None | LazyStack.Client.ViewModels |
| Auth | LazyStack.Client.Auth |
| Auth.Notifications | LazyStack.Client.Auth.Notifications |
